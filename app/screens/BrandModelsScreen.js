...
import { View, Text, StyleSheet, Image, FlatList, SafeAreaView, TouchableOpacity, Platform, StatusBar, Linking, ScrollView } from 'react-native';
...
const BrandModelsScreen = () => {
  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: '#193A7A' }}>
