...
const FeaturedCarsScreen = ({ navigation, route }) => {
  ...
  useEffect(() => {
    const loadFeaturedVehicles = async () => {
      ...
      try {
        ...
        const response = await featuredVehiclesService.getFeaturedVehicles(50); // Get more featured vehicles
        ...
        if (response && response.data) {
          ...
          console.log('All featured vehicles from API:', allVehicles);
          ...
          setFeaturedCars(transformedVehicles);
          setFilteredCars(transformedVehicles);
        } else {
          console.log('No featured vehicles data');
          setFeaturedCars([]);
          setFilteredCars([]);
        }
      } catch (error) {
  ...
  const handleSearch = (text) => {
    ...
    if (text.trim() === '') {
      ...
      const searchResults = featuredCars.filter(car => {
        ...
        <View style={{ position: 'absolute', top: insets.top , left: 0, right: 0, zIndex: 200 }}>
          <View style={styles.filterBar}>
            <ScrollView horizontal showsHorizontalScrollIndicator={false} contentContainerStyle={[styles.topTabs, { direction: 'ltr' }]}>
              ...
              <TouchableOpacity style={styles.filterBtn}><Text style={styles.filterBtnText}>Featured</Text></TouchableOpacity>
            </ScrollView>
          </View>
          <View style={styles.resultsRow}>
            <Text style={styles.resultsText}>{featuredCars.length} featured results</Text>
      ...
      >
        ...
        <View style={styles.resultsRow}>
          <Text style={styles.resultsText}>
            {isSearching ? `Search results: ${filteredCars.length}` : `${filteredCars.length} featured results`}
          </Text>
          <TouchableOpacity><Text style={styles.saveSearch}>Save Search</Text></TouchableOpacity>
        </View>
        ...
        {apiError && !isLoading && (
          <View style={styles.errorContainer}>
            ...
            <Text style={styles.errorSubtext}>Unable to load featured vehicles</Text>
          </View>
        )}
        ...
        {!isLoading && !apiError && filteredCars.length === 0 && (
          <View style={styles.emptyContainer}>
            <Text style={styles.emptyText}>No featured vehicles found</Text>
          ...
          >
            ...
            <View style={styles.badgesRow}>
              <View style={styles.featuredBadgeRow}>
                <Image source={require('../assets/images/badge.png')} style={styles.featuredBadgeIcon} />
                <View style={styles.featuredBadgeTextBg}>
      ...
      <AuthModal
        ...
        onSignIn={() => {
          ...
          navigation.navigate('SignInScreen', {
            returnScreen: 'FeaturedCarsScreen',
...
const styles = StyleSheet.create({
  ...
  featuredBadgeIcon: { width: 22, height: 22, marginRight: 4, resizeMode: 'contain' },
  featuredBadgeTextBg: { backgroundColor: '#f3f4f6', paddingHorizontal: 6, borderRadius: 6, alignSelf: 'center', marginLeft: -4 },
  featuredBadgeText: { color: '#222222', fontWeight: '700', fontSize: 11 },
...
export default FeaturedCarsScreen; 